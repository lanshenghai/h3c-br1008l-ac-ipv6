...
**推荐刷 [`firmware/HM1A0V100R013.bin`](firmware/HM1A0V100R013.bin)。**  
当前仓库里的 `HM1A0V100R012.bin` 与 `R013.bin` **内容相同**（仅为旧文件名兼容）。设备上的版本字符串是 **R013**。若以前刷过历史 R012（`etc/rc` 钩子那版），请再刷一次本仓库的 R013。
