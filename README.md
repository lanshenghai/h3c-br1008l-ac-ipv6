...
- [`firmware/HM1A0V100R014.bin`](firmware/HM1A0V100R014.bin)（推荐）  
- [`firmware/HM1A0V100R013.bin`](firmware/HM1A0V100R013.bin) / [`HM1A0V100R012.bin`](firmware/HM1A0V100R012.bin)（与 R014 **同一镜像**，仅文件名不同）

基于官方 `HM1A0V100R011` 改包，版本头为 `HM1A0V100R014`，并已按设备校验方式重签 payload checksum。
